...
import { authLoginSchema, authRegisterSchema, verifyEmailSchema } from "../schemas/authSchemas.js";
...
authRouter.post("/verify", validateBody(verifyEmailSchema), authControllers.resendVerifyController);
